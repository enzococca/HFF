...
class SHIPWRECK(object):
    ...
    def __init__(self,
            ...
            self.id_shipwreck= id_shipwreck
            self.code_id= code_id 
            self.name_vessel = name_vessel
            self.yard = yard
            self.area = area
            ...
            self.position_quality_1 = position_quality_1
            self.longitude = longitude
            self.consulties = consulties
            self.l = l
            self.w = w
            self.d = d
            self.t= t
