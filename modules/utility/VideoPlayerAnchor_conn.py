...
from ..db.hff_system__utility import Utility
...
class VideoPlayerWindow(QMainWindow):
    ...
    def generate_US(self):
        ...
        records = self.DB_MANAGER.query_bool(search_dict, 'ANC_c')

        us_list = []
        for record in records:
            if hasattr(record, 'id_anc'):
                us_list.append([record.id_anc, 'ANC_CON', 'anchor_con'])
            else:
