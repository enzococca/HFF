...
class pyarchinit_Pottery(QDialog, MAIN_DIALOG_CLASS):
    ...
    def charge_list(self):
        ...
        try:
            ...
            if str(e) == "list.remove(x): x not in list":
                ...
                QMessageBox.warning(self, "Message", "Update system in specific shape list: " + str(e), QMessageBox.Ok)
    ...
    def insert_new_rec(self):
        ...
        try:
            ...
            self.DB_MANAGER.max_num_id(self.MAPPER_TABLE_CLASS, self.ID_TABLE)+1,
                    ...
                    str(self.lineEdit_provenience.text()),
    ...
    def on_pushButton_search_go_pressed(self):
        ...
        if self.BROWSE_STATUS != "f":
            ...
            self.TABLE_FIELDS[1]  : "'"+str(self.comboBox_site.currentText())+"'",                              #2 - Area
            ...
            self.TABLE_FIELDS[7]  : "'"+str(self.comboBox_fabric.currentText())+"'",                                #8 - periodo iniziale
            self.TABLE_FIELDS[8]  : "'"+str(self.comboBox_percent.currentText())+"'",                               #9 - fase iniziale
            self.TABLE_FIELDS[9]  : "'"+str(self.comboBox_specific_form.currentText())+"'",                             #10 - periodo finale iniziale
            self.TABLE_FIELDS[10] : "'"+str(self.comboBox_specific_shape.currentText())+"'",                                #11 - fase finale
            self.TABLE_FIELDS[11] : "'"+str(self.comboBox_typology.currentText())+"'",                              #12 - scavato 
            self.TABLE_FIELDS[12] : "'"+str(self.lineEdit_provenience.text())+"'",                                              #13 - attivita  
            self.TABLE_FIELDS[13] : "'"+str(self.comboBox_munsell.currentText())+"'",                                                   #14 - anno scavo
            self.TABLE_FIELDS[14] : "'"+str(self.comboBox_surf_trat.currentText())+"'",                                 #15 - metodo
            #self.TABLE_FIELDS[15] : "'"+unicode(self.comboBox_deco.currentText())+"'", 
            self.TABLE_FIELDS[16] : "'"+str(self.comboBox_intdeco.currentText())+"'",
            self.TABLE_FIELDS[17] : "'"+str(self.comboBox_treatment.currentText())+"'",
            self.TABLE_FIELDS[18] : "'"+str(self.lineEdit_depth.text())+"'",#16 - data schedatura
            self.TABLE_FIELDS[19] : "'"+str(self.lineEdit_storage_.text())+ "'",
            self.TABLE_FIELDS[20] : "'"+str(self.lineEdit_period.text())+ "'",
            self.TABLE_FIELDS[21] : "'"+str(self.lineEdit_state.text())+ "'",               #19 - conservazione
            self.TABLE_FIELDS[22] : "'"+str(self.comboBox_samples.currentText())+ "'",  
            self.TABLE_FIELDS[23] : "'"+str(self.comboBox_washed.currentText())+ "'",
            self.TABLE_FIELDS[24] : "'"+str(self.lineEdit_dm.text())+ "'",                              #15 - metodo
            self.TABLE_FIELDS[25] : "'"+str(self.lineEdit_dr.text())+ "'",  
            self.TABLE_FIELDS[26] : "'"+str(self.lineEdit_db.text())+ "'",
            self.TABLE_FIELDS[27] : "'"+str(self.lineEdit_th.text())+ "'",
            self.TABLE_FIELDS[28] : "'"+str(self.lineEdit_ph.text())+ "'",
            self.TABLE_FIELDS[29] : "'"+str(self.lineEdit_bh.text())+ "'",
            self.TABLE_FIELDS[30] : "'"+str(self.lineEdit_thickmin.text())+ "'",
            self.TABLE_FIELDS[31] : "'"+str(self.lineEdit_thickmax.text())+ "'",
            self.TABLE_FIELDS[32] : anno,
            self.TABLE_FIELDS[33] : box,
            self.TABLE_FIELDS[35] : str(self.textEdit_description.toPlainText()),
            self.TABLE_FIELDS[36] : "'"+str(self.comboBox_area.currentText())+ "'",
            self.TABLE_FIELDS[37] : "'"+str(self.comboBox_munsell_surf.currentText())+ "'",
            self.TABLE_FIELDS[38] : "'"+str(self.comboBox_category.currentText())+ "'"
            }
    ...
    def fill_fields(self, n=0):
        ...
        try:
            ...
            str(self.comboBox_site.setEditText(self.DATA_LIST[self.rec_num].sito))  
            str(self.lineEdit_date.setText(self.DATA_LIST[self.rec_num].data_))
            ...
            str(self.comboBox_percent.setEditText(self.DATA_LIST[self.rec_num].percent))
            ...
            str(self.lineEdit_provenience.setText(self.DATA_LIST[self.rec_num].provenience))
            str(self.comboBox_munsell.setEditText(self.DATA_LIST[self.rec_num].munsell))
            str(self.comboBox_surf_trat.setEditText(self.DATA_LIST[self.rec_num].surf_trat))
            # unicode(self.comboBox_deco.setEditText(self.DATA_LIST[self.rec_num].decoration))
            str(self.comboBox_intdeco.setEditText(self.DATA_LIST[self.rec_num].intdeco))
    ...
    def set_LIST_REC_TEMP(self):
        ...
        str(self.comboBox_site.currentText()),                      #1 - Sito
        str(self.lineEdit_date.text()),
        str(self.comboBox_artefact.currentText()),
        str(self.comboBox_photo.currentText()),
        str(self.comboBox_draw.currentText()),
    ...
    def generate_list_pdf(self):
        ...
        for i in range(len(self.DATA_LIST)):
            ...
            str(self.DATA_LIST[i].percent), 
            str(self.DATA_LIST[i].provenience), 
            str(self.DATA_LIST[i].munsell), 
            str(self.DATA_LIST[i].munsell_surf),
            str(self.DATA_LIST[i].surf_trat),   
            str(self.DATA_LIST[i].decoration),  
            str(self.DATA_LIST[i].intdeco), 
