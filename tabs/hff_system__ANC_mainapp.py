        ...
        if os.path.exists(path_key):
            ...
            with open(path_key, 'r') as f:
                ...
                try:
                    ...
                    reply = QMessageBox.question(self, 'Warning', 'Apikey not valid' + '\n'
                                                 + 'Click ok to insert a new apikey or cancel to exit',
                                                 QMessageBox.Ok | QMessageBox.Cancel)
                    if reply == QMessageBox.Ok:

                        api_key, ok = QInputDialog.getText(self, 'Apikey gpt', 'Insert an valid apikey:')
                        if ok:
