...
##                  res_media = self.DB_MANAGER.query_bool(search_dict, "MEDIA")
    ...
    def tableInsertData(self, t, d):
        ...
        # clear all rows before repopulating — old loop iterated on
        # columnCount() (wrong dimension) with growing indices while rows
        # shifted, leaving orphan rows. sort() was also reordering rows
        # lexicographically, so photo_id="10" landed before "2".
