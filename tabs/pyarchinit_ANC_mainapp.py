...
MAIN_DIALOG_CLASS, _ = loadUiType(
    os.path.join(os.path.dirname(__file__), os.pardir, 'gui', 'ui', 'pyarchinit_ANCHOR_ui.ui'))




class pyarchinit_ANC(QDialog, MAIN_DIALOG_CLASS):
    ...
    def insert_new_rec(self):
        ...
        try:
            ...
            str(self.lineEdit_wight.text()),
            str(self.comboBox_origin.currentText()),
            str(self.comboBox_comparision.currentText()),
    ...
    def on_pushButton_search_go_pressed(self):
        if self.BROWSE_STATUS != "f":
            ...
            self.TABLE_FIELDS[9] : "'"+str(self.lineEdit_wight.text())+"'",
            self.TABLE_FIELDS[10] : "'"+str(self.comboBox_origin.currentText())+"'",
            self.TABLE_FIELDS[11]  : "'"+str(self.comboBox_comparision.currentText())+"'",
    ...
    def fill_fields(self, n=0):
        ...
        try:
            ...
            str(self.lineEdit_wight.setText(self.DATA_LIST[self.rec_num].wight))        
            str(self.comboBox_origin.setEditText(self.DATA_LIST[self.rec_num].origin))
            str(self.comboBox_comparision.setEditText(self.DATA_LIST[self.rec_num].comparision))
    ...
    def generate_list_pdf(self):
        ...
        for i in range(len(self.DATA_LIST)):
            ...
            str(self.DATA_LIST[i].wight),
            str(self.DATA_LIST[i].origin),
            str(self.DATA_LIST[i].comparision),
            ...
            str(self.DATA_LIST[i].hrt),
            str(self.DATA_LIST[i].hrr),
            str(self.DATA_LIST[i].hrl),
            str(self.DATA_LIST[i].hdt),
            str(self.DATA_LIST[i].hd5),
            str(self.DATA_LIST[i].hdl),
            str(self.DATA_LIST[i].flt),
            str(self.DATA_LIST[i].flr),
            str(self.DATA_LIST[i].fll),
            str(self.DATA_LIST[i].frt),
            str(self.DATA_LIST[i].frr),
            str(self.DATA_LIST[i].frl),
            str(self.DATA_LIST[i].fbt),
            str(self.DATA_LIST[i].fbr),
            str(self.DATA_LIST[i].fbl),
            str(self.DATA_LIST[i].ftt),
            str(self.DATA_LIST[i].ftr),
            str(self.DATA_LIST[i].ftl),
