...
class PyArchInitPlugin(object):
    ...
    def initGui(self):
        ...
        #self.docToolButton.addActions([self.actionImages_Directory_export])
        ...
        # menu
        self.iface.addPluginToMenu("&pyArchInit - Archaeological GIS Tools", self.actionUW)
        self.iface.addPluginToMenu("&pyArchInit - Archaeological GIS Tools", self.actionANC)
        self.iface.addPluginToMenu("&pyArchInit - Archaeological GIS Tools", self.actionART)
    ...
    def unload(self):
        ...
        # l=QgsSettings().value("locale/userLocale")[0:2] 
        # if l == 'it':
        self.iface.removePluginMenu("&pyArchInit - Archaeological GIS Tools", self.actionUW)
        self.iface.removePluginMenu("&pyArchInit - Archaeological GIS Tools", self.actionANC)
        self.iface.removePluginMenu("&pyArchInit - Archaeological GIS Tools", self.actionART)
